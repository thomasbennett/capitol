...
function add_theme_readme() {
	...
	// ADE/Push - 10-jun-2014 - changed below from 'administrator' to 'manage_options'
	add_menu_page('Theme Help', 'Theme Help', 'manage_options', 'theme-readme', 'theme_include_help');
}
